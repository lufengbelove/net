openerp.COMMCMDB.SelectRelationPage = function(instance) {
    ...
    instance.COMMCMDB.SelectRelation = instance.web.Widget.extend({ // 自定义首页部件
    	template: "Custom",
    	toString:function(){
    		return "instance.COMMCMDB.SelectRelation";
    	},
        start: function() {
        	this.$el.height(400);
        	var areaHeight = this.$el.height();
        	this.searchbar = new instance.COMMCMDB.SearchBar(this,{x:55,y:18},"commcmdb.citemplate");
        	...
        	this.relation = new  instance.COMMCMDB.Many2OneSelection(this,{ height:22,width:20,x:12.5,y:5.5 },"commcmdb.relation");
        	this.relationlebel = new instance.COMMCMDB.Label(this,{ width:10,x:1,y:4.5 },"关系");
        	...
        	var okbtn = new instance.COMMCMDB.DialogButton(this.getParent().$buttons,"确定",function(){
        		...
        		self.client.selectRelationId = relationId;
        		self.client.selectRelationName = relationName;
