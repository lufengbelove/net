openerp.COMMCMDB.CIExpendEditPage = function(instance) {
    ...
    instance.COMMCMDB.CIExpendEdit = instance.web.Widget.extend({ // 自定义首页部件
    	template: "Custom",
    	toString:function(){
    		return "instance.COMMCMDB.CIExpendEdit";
    	},
        start: function() {
        	this.$el.height(400);
        	var areaHeight = this.$el.height();
        	this.searchbar = new instance.COMMCMDB.SearchBar(this,{x:55,y:18},"ir.attachment");
